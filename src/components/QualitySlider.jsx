  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
        <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-gray-800">Quality Adjustment</h2>
        ...
        {isDisabled ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 text-lg">PNG quality adjustment unavailable</p>
            <p className="text-gray-400 text-sm mt-2">PNG is a lossless compression format</p>
          </div>
        ) : (
          ...
          <div>
            ...
            <div className="flex justify-between text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6 px-2">
              <span>Low</span>
              <span className="hidden sm:inline">Medium (50%)</span>
              <span>High</span>
            </div>
              ...
              <div className="flex items-start">
                ...
                <div className="text-sm text-gray-600">
                  ...
                  <ul className="space-y-1 text-xs">
                    <li>• High quality: Sharper image but larger file size</li>
                    <li>• Low quality: Smaller file but reduced image quality</li>
                    <li>• Recommended: 70-85% for web, 90-100% for print</li>
                  </ul>
                </div>
              </div>
            </div>
